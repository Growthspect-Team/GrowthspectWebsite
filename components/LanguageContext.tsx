...
const translations = {
    cs: {
        ...
        'hero.title.part1': 'Architekti digitální budoucnosti.',
        'hero.title.part2': 'Rychlejší díky AI.',
        'hero.subtitle': 'Projektujeme a implementujeme komplexní řešení s efektivitou umělé inteligence a architektonickou pákou pro neomezený růst.',
    ...
    en: {
        ...
        'contact.title': 'Got a new project?',
